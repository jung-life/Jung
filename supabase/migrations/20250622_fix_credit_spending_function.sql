-- Fix Credit Spending Function - Resolve Ambiguous Column Reference
-- Migration: 20250622_fix_credit_spending_function.sql
-- 
-- This migration fixes the "column reference 'current_balance' is ambiguous" error
-- by using explicit table aliases and renaming variable names to avoid conflicts.
...
DO $$
BEGIN
  RAISE NOTICE 'Credit spending functions have been successfully fixed!';
  RAISE NOTICE 'The ambiguous column reference error should now be resolved.';
  RAISE NOTICE 'Test by sending a message in your app - credits should deduct properly.';
END $$;
